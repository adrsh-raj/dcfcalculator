...
def main():
    ...
    st.markdown("[EXPLAINATION OF DCF (click here)](#working)")
 ...
 ''')
    ...
    with st.expander('Working click to expand'):
        st.markdown(f"<h2 id='section-1'>working</h2>", unsafe_allow_html=True)
        working()
    st.caption(":black[More to come......for US by Me]")    


def working():
    st.title("Bit of explainations")
    st.markdown("""
    ...
    """)
    st.image('img.png', caption="DCF Analysis")
